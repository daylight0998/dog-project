...
"resource": {
  ...
  "rules":[
    [["if",0],["add",0,5,6,12,20,29,32,35,36,45,69,75,79,80]],
    [["if",1],["add",0]],
    [["if",2],["add",1,5,7,21,81]],
    [["if",3,4],["add",2,3,4,40]],
    [["if",3,5],["add",3,9,41]],
    [["if",5,6],["add",3,9,42]],
    [["if",4],["add",5,8]],
    ...
    [["if",11],["add",13]],
    [["if",12],["add",13]],
    [["if",13,14],["add",14,15,48,50,27,28]],
    [["if",14,15],["add",16,49,51]],
    [["if",5,16],["add",17,19,57]],
    [["if",0,17],["add",17,19,57,60]],
    [["if",5,18,19],["add",18,57]],
    [["if",0,20],["add",18,19,57,61]],
    [["if",5,21],["add",19,59]],
    [["if",5,22],["add",22]],
    [["if",0,23],["add",23,43,44,62,63,52,53]],
    [["if",24,25],["add",24,25,30,31,66,70,71,72,73,74,77]],
    [["if",24,25,26],["add",26]],
    [["if",5,27],["add",34]],
    [["if",5,28],["add",35]],
    [["if",5],["add",37,38,67,76,78]],
    [["if",5,29],["add",39]],
    [["if",5,30],["add",44,47,58,59,62]],
    [["if",31,32],["add",44,62]],
    [["if",5,33],["add",46]],
    [["if",5,34],["add",52,59]],
    [["if",32,35],["add",52]],
    [["if",5,36],["add",54]],
    [["if",5,37],["unless",38],["add",55]],
    [["if",5,39],["add",56]],
    [["if",5,40],["add",59]],
    [["if",5,41],["add",59]],
    [["if",5,42],["add",59]],
